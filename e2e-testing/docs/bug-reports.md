# Bug Reports - Auto Service 5 Features Testing

Dokumen ini mendata seluruh *bug* / anomali yang ditemukan selama pengujian otomatis terhadap 5 fitur utama Auto Service berdasarkan pembagian tugas kelompok.

---

## BUG-001: Ketiadaan Validasi Input Harga Negatif pada Halaman Tambah Item (Owner - Janu)
*   **Bug ID**: BUG-001
...
## BUG-002: Layout Pecah Akibat Ketiadaan Batas Karakter Nama Jasa (Owner - Janu)
*   **Bug ID**: BUG-002
...
*   **Preconditions**:
    *   Penguji login sebagai Owner.
*   **Steps to Reproduce**:
    1. Buka menu Katalog Jasa $\rightarrow$ Klik **Tambah Jasa**.
...
## BUG-003: Duplikasi Pelat Nomor Kendaraan pada Antrean Aktif (Admin - Fahim)
*   **Bug ID**: BUG-003
...
## BUG-004: Penerimaan Transaksi Pembayaran Kurang Tanpa Validasi (Kasir - Akmal)
*   **Bug ID**: BUG-004
...
## BUG-005: Pengiriman Checklist Kosong Berhasil Disimpan (Mekanik - Hafidz)
*   **Bug ID**: BUG-005
...
*   **Steps to Reproduce**:
    1. Buka antrean kendaraan aktif $\rightarrow$ klik **Mulai Inspeksi**.
